...
struct alignas(1) TestCT final {
    ...
    template <class T>
    static noinline T *noinline_ptr_align_down(T * p, size_t a) noexcept {
        return ptr_align_down(p, a);
    }
    template <class T>
    static noinline T *noinline_ptr_align_up(T * p, size_t a) noexcept {
        return ptr_align_up(p, a);
    }

    template <class T>
    static noinline T *noinline_ptr_align_down_16(T * p) noexcept {
        return ptr_align_down(p, 16);
    }
    template <class T>
    static noinline T *noinline_ptr_align_up_16(T * p) noexcept {
...
TEST_CASE("upx::run_time 2") {
    ...
    MemBuffer mb(32);
    mb.clear();
    void *const mb_a = TestCT::noinline_ptr_align_up_16(mb.getVoidPtr());
    {
        const byte *b = upx::ptr_static_cast<const byte *>(mb_a);
    ...
    {
        upx_uint16_t *b = upx::ptr_static_cast<upx_uint16_t *>(mb_a);
        assert_noexcept2(ptr_is_aligned(b, 16));
        assert_noexcept2(TestCT::noinline_ptr_align_down(b + 1, a) == b);
        assert_noexcept2(TestCT::noinline_ptr_align_up(b + 1, a) == b + 4);
        assert_noexcept2(TestCT::noinline_ptr_align_down_16(b + 1) == b);
        assert_noexcept2(TestCT::noinline_ptr_align_up_16(b + 1) == b + 8);
    }
    {
        upx_uint32_t *b = upx::ptr_static_cast<upx_uint32_t *>(mb_a);
        assert_noexcept2(ptr_is_aligned(b, 16));
        assert_noexcept2(TestCT::noinline_ptr_align_down(b + 1, a) == b);
        assert_noexcept2(TestCT::noinline_ptr_align_up(b + 1, a) == b + 2);
        assert_noexcept2(TestCT::noinline_ptr_align_down_16(b + 1) == b);
        assert_noexcept2(TestCT::noinline_ptr_align_up_16(b + 1) == b + 4);
    }
    {
        upx_uint64_t *b = upx::ptr_static_cast<upx_uint64_t *>(mb_a);
        assert_noexcept2(ptr_is_aligned(b, 16));
        assert_noexcept2(TestCT::noinline_ptr_align_down(b + 1, a) == b + 1);
        assert_noexcept2(TestCT::noinline_ptr_align_up(b + 1, a) == b + 1);
        assert_noexcept2(TestCT::noinline_ptr_align_down_16(b + 1) == b);
        assert_noexcept2(TestCT::noinline_ptr_align_up_16(b + 1) == b + 2);
    }
}
...
#if (__SIZEOF_INT128__ == 16)
    template <class To, class From>
    static noinline To noinline_cast3(From, upx_uint128_t from) noexcept {
        return To(From(from));
    }
#else
    template <class To, class From>
    static noinline To noinline_cast3(From, upx_uint64_t from) noexcept {
        return To(From(from));
    }
#endif
};
...
struct TestConstant final {
    ...
    template <class T>
    static noinline T noinline_ne6(T n) noexcept {
        return n == 41 ? 0 : T(-1);
    }
    template <class T>
    static noinline T noinline_ne7(T n) noexcept {
        return n == 41 || n == 91 ? 0 : T(-1);
    }
    template <class T>
    static noinline T noinline_ne8(T n) noexcept {
        return n == 41 || n == 91 || n == 117 ? 0 : T(-1);
    }
    template <class T>
    static noinline T noinline_ne9(T n) noexcept {
        return n == 41 || n == 91 || n == 117 || n == 127 ? 0 : T(-1);
    }

    template <class T>
    static noinline T noinline_sw6(T n) noexcept {
        switch (n) {
        case 41:
            return 0;
        }
    ...
    template <class T>
    static noinline T noinline_sw7(T n) noexcept {
        switch (n) {
        case 41:
        case 91:
            return 0;
    ...
    template <class T>
    static noinline T noinline_sw8(T n) noexcept {
        switch (n) {
        case 41:
        case 91:
        case 117:
    ...
    template <class T>
    static noinline T noinline_sw9(T n) noexcept {
        switch (n) {
        case 41:
        case 91:
        case 117:
...
TEST_CASE("codegen cast") {
    const int n = acc_vget_int(0, 0);
    {
        typedef upx_int8_t T;
        assert_noexcept2((TestCast::noinline_cast<T>(upx_int8_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_uint8_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_int16_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_uint16_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_int32_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_uint32_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_int64_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_uint64_t(n)) == 0));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestCast::noinline_cast<T>(upx_int128_t(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_uint128_t(n)) == 0));
#endif
        assert_noexcept2((TestCast::noinline_cast<T>(float(n)) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(double(n)) == 0));
    }
    {
...
TEST_CASE("codegen cast 2+3") {
#define noinline_cast noinline_cast3
    const int n = acc_vget_int(0, 0);
    {
        typedef upx_int8_t T;
...
#endif
        assert_noexcept2((TestCast::noinline_cast2<T>(float(n), n) == 0));
        assert_noexcept2((TestCast::noinline_cast2<T>(double(n), n) == 0));
    }
    {
        typedef upx_uint8_t T;
        assert_noexcept2((TestCast::noinline_cast<T>(upx_int8_t(n), n) == 0));
    ...
    }
    {
        ...
        assert_noexcept2((TestCast::noinline_cast<T>(upx_int128_t(n), n) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(upx_uint128_t(n), n) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(float(n), n) == 0));
        assert_noexcept2((TestCast::noinline_cast<T>(double(n), n) == 0));
#endif
    }
    {
#if (__SIZEOF_INT128__ == 16)
...
TEST_CASE("codegen constant") {
    ...
    const bool t = acc_vget_int(1, 0);
    {
...
#endif
        assert_noexcept2((TestConstant::noinline_zero(float(n)) == 0));
        assert_noexcept2((TestConstant::noinline_zero(double(n)) == 0));
...
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_one(upx_int128_t(n)) == 1));
        assert_noexcept2((TestConstant::noinline_one(upx_uint128_t(n)) == 1));
#endif
        assert_noexcept2((TestConstant::noinline_one(float(n)) == 1));
        assert_noexcept2((TestConstant::noinline_one(double(n)) == 1));
...
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_minus_one(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_minus_one(upx_uint128_t(n)) != 0));
#endif
        assert_noexcept2((TestConstant::noinline_minus_one(float(n)) == -1));
        assert_noexcept2((TestConstant::noinline_minus_one(double(n)) == -1));
        ...
        assert_noexcept2((TestConstant::noinline_0xff(float(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_0xff(double(n)) == 0xff));
        ...
        assert_noexcept2((TestConstant::noinline_0xffff(float(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_0xffff(double(n)) == 0xffff));
        ...
        // assert_noexcept2((TestConstant::noinline_0xffffffff(float(n)) == 0x100000000ll));
        assert_noexcept2((TestConstant::noinline_0xffffffff(double(n)) == 0xffffffff));
        ...
        assert_noexcept2((TestConstant::noinline_add_zero(float(n)) == 0));
        assert_noexcept2((TestConstant::noinline_add_zero(double(n)) == 0));
...
#endif
        assert_noexcept2((TestConstant::noinline_add_one(float(n)) == 1));
        assert_noexcept2((TestConstant::noinline_add_one(double(n)) == 1));
...
#endif
        assert_noexcept2((TestConstant::noinline_add_minus_one(float(n)) == -1));
        assert_noexcept2((TestConstant::noinline_add_minus_one(double(n)) == -1));
        ...
        assert_noexcept2((TestConstant::noinline_add_0xff(float(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_add_0xff(double(n)) == 0xff));
        ...
        assert_noexcept2((TestConstant::noinline_add_0xffff(float(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_add_0xffff(double(n)) == 0xffff));
        ...
        // assert_noexcept2((TestConstant::noinline_add_0xffffffff(float(n)) == 0x100000000ll));
        assert_noexcept2((TestConstant::noinline_add_0xffffffff(double(n)) == 0xffffffff));
...
#endif
        assert_noexcept2((TestConstant::noinline_add(float(a), float(b)) == 1));
        assert_noexcept2((TestConstant::noinline_add(double(a), double(b)) == 1));
...
#endif
        assert_noexcept2((TestConstant::noinline_sub(float(a), float(b)) == -1));
        assert_noexcept2((TestConstant::noinline_sub(double(a), double(b)) == -1));
...
#endif
        assert_noexcept2((TestConstant::noinline_mul(float(a), float(b)) == 0));
        assert_noexcept2((TestConstant::noinline_mul(double(a), double(b)) == 0));
...
#endif
        assert_noexcept2((TestConstant::noinline_div(float(a), float(b)) == 0));
        assert_noexcept2((TestConstant::noinline_div(double(a), double(b)) == 0));
        ...
        assert_noexcept2((TestConstant::noinline_add_mul(upx_uint128_t(n), upx_uint128_t(a),
                                                         upx_uint128_t(b)) == 0));
#endif
        assert_noexcept2((TestConstant::noinline_add_mul(float(n), float(a), float(b)) == 0));
        assert_noexcept2((TestConstant::noinline_add_mul(double(n), double(a), double(b)) == 0));
        ...
        assert_noexcept2((TestConstant::noinline_add_div(upx_uint64_t(n), upx_uint64_t(a),
                                                         upx_uint64_t(b)) == 0));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_add_div(upx_int128_t(n), upx_int128_t(a),
                                                         upx_int128_t(b)) == 0));
        assert_noexcept2((TestConstant::noinline_add_div(upx_uint128_t(n), upx_uint128_t(a),
                                                         upx_uint128_t(b)) == 0));
#endif
        assert_noexcept2((TestConstant::noinline_add_div(float(n), float(a), float(b)) == 0));
        assert_noexcept2((TestConstant::noinline_add_div(double(n), double(a), double(b)) == 0));
    ...
    }
    {
        ...
        assert_noexcept2((TestConstant::noinline_ne6(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne6(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_ne6(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne6(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_ne6(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne6(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_ne6(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne6(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_ne6(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne6(upx_uint128_t(n)) != 0));
#endif

        assert_noexcept2((TestConstant::noinline_ne7(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne7(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_ne7(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne7(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_ne7(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne7(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_ne7(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne7(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_ne7(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne7(upx_uint128_t(n)) != 0));
#endif

        assert_noexcept2((TestConstant::noinline_ne8(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne8(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_ne8(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne8(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_ne8(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne8(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_ne8(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne8(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_ne8(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne8(upx_uint128_t(n)) != 0));
#endif

        assert_noexcept2((TestConstant::noinline_ne9(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne9(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_ne9(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne9(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_ne9(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne9(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_ne9(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne9(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_ne9(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_ne9(upx_uint128_t(n)) != 0));
#endif
    }
    {
        assert_noexcept2((TestConstant::noinline_sw6(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw6(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_sw6(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw6(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_sw6(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw6(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_sw6(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw6(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_sw6(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw6(upx_uint128_t(n)) != 0));
#endif

        assert_noexcept2((TestConstant::noinline_sw7(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw7(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_sw7(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw7(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_sw7(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw7(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_sw7(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw7(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_sw7(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw7(upx_uint128_t(n)) != 0));
#endif

        assert_noexcept2((TestConstant::noinline_sw8(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw8(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_sw8(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw8(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_sw8(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw8(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_sw8(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw8(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_sw8(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw8(upx_uint128_t(n)) != 0));
#endif

        assert_noexcept2((TestConstant::noinline_sw9(upx_int8_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw9(upx_uint8_t(n)) == 0xff));
        assert_noexcept2((TestConstant::noinline_sw9(upx_int16_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw9(upx_uint16_t(n)) == 0xffff));
        assert_noexcept2((TestConstant::noinline_sw9(upx_int32_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw9(upx_uint32_t(n)) == 0xffffffff));
        assert_noexcept2((TestConstant::noinline_sw9(upx_int64_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw9(upx_uint64_t(n)) == 0xffffffffffffffffULL));
#if (__SIZEOF_INT128__ == 16)
        assert_noexcept2((TestConstant::noinline_sw9(upx_int128_t(n)) == -1));
        assert_noexcept2((TestConstant::noinline_sw9(upx_uint128_t(n)) != 0));
#endif
    }
    {
